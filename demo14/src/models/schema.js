...
function initializeDatabase() {
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS criterios_evaluacion (
      ...
      FOREIGN KEY (ciclo_id) REFERENCES ciclos_evaluacion(id)
    );
    ...
    CREATE TABLE IF NOT EXISTS evaluaciones (
      ...
      tipo_evaluador TEXT NOT NULL DEFAULT 'Par',
      token TEXT UNIQUE,
      completada INTEGER DEFAULT 0,
      fecha_completada TEXT,
      created_at TEXT DEFAULT (datetime('now')),
      FOREIGN KEY (ciclo_id) REFERENCES ciclos_evaluacion(id),
      FOREIGN KEY (evaluado_id) REFERENCES empleados(id)
    );
    ...
    CREATE INDEX IF NOT EXISTS idx_evaluaciones_ciclo ON evaluaciones(ciclo_id, evaluado_id);
    CREATE INDEX IF NOT EXISTS idx_respuestas ON respuestas_evaluacion(evaluacion_id);
